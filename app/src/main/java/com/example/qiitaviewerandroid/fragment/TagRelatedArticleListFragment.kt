 ...
 * Use the [TagRelatedArticleListFragment.newInstance] factory method to
...
class TagRelatedArticleListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment TagRelatedArticleListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic fun newInstance(param1: String, param2: String) =
                TagRelatedArticleListFragment().apply {
